...
class ImdbTopSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        movie_list = json_data.get('itemListElement')
        ...
        for movie in movie_list:
            ...
            all_movies_lst.append(movie_dict)
        print(all_movies_lst)
        col_names=['Title','Image_path','URL_path','Rating','Duration']
        with open(r'C:\Users\Madri.Gadani\Desktop\madri\imdb\imdb_top_250.csv', mode='w', newline='', encoding='utf-8') as file:
            writer = csv.DictWriter(file, fieldnames=col_names)

            writer.writeheader()  # Write the column headers
            writer.writerows(all_movies_lst)


        print("CSV file 'imdb_top_250.csv' has been created successfully.")
        ...
        # print(url_path)
        # # year=json_data['itemListElement'][1]['item']['year']
        # # print('year',year)
        #
...
if __name__ == '__main__':
        execute(f'scrapy crawl imdb_top'.split())
