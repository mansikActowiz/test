...
for i in zip_list:
    ...
    with open(f'D:\madri_new_codes\oppo\saved_json_all_pincodes_db\pincode_{i}.json','w',encoding='utf-8') as f:
...
print(output_df)
# exit(0)
oppo_output_csv='D:\madri_new_codes\oppo\oppo_output_csv\oppo_scope-_2_all_pincodes_db.csv'
