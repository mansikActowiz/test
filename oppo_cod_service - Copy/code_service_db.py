...
conn=mysql.connector.connect(
    ...
    user="root",
    passwd="Actowiz",
    database="oppo_cod_service")

cursor=conn.cursor()
cursor.execute('''CREATE TABLE IF NOT EXISTS oppo_cod_service (
               id INT AUTO_INCREMENT PRIMARY KEY,
               zipcode VARCHAR(11) NOT NULL,
               product_url VARCHAR(100) NOT NULL,
               oppo_servicability int NOT NULL,
               oppo_cod_availability int NOT NULL)''')
...
for i in zip_list:
    ...
    with open(f'D:\madri_new_codes\oppo\pincode_{i}.html','w',encoding='utf-8') as f:
